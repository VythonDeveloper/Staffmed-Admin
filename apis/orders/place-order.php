...
$mandatoryVal = isset($_POST['userId']) && isset($_POST['amount']) && isset($_POST['productArray']) && isset($_POST['quantityArray']) && isset($_POST['orderTimeSlot']) && isset($_POST['orderDateRange']);
